  ...
  return (
    <div style={{ 
      ...
      <p style={{ color: 'white', marginBottom: '30px', maxWidth: '600px' }}>
        This page allows you to test the new onboarding guide featuring Rob as the world guide. 
        Click the button below to start the immersive onboarding experience.
      </p>

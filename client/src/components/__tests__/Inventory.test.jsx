...
describe('Inventory Component', () => {
  ...
  test('shows message input for artifacts', () => {
    ...
    expect(screen.getByPlaceholderText('Add a personal note about this artifact...')).toBeInTheDocument();
  });
  ...
  test('handles message saving', async () => {
    ...
    const messageInput = screen.getByPlaceholderText('Add a personal note about this artifact...');
  ...
  test('shows artifact rarity indicators', () => {
    ...
    const commonItem = screen.getByText('Test Artifact 1').closest('.inventory-item');
    const rareItem = screen.getByText('Test Artifact 2').closest('.inventory-item');
  ...
  test('handles error state', () => {
    ...
    expect(screen.getByText('Error: Failed to load inventory')).toBeInTheDocument();
  });

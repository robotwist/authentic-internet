  ...
  const steps = [
    {
      ...
      choices: ['Tell me more about artifacts', 'What do you mean by "first artifact"?', 'How do I start exploring?']
    },
    {
      ...
      choices: ['So this game is an artifact?', 'How do I create artifacts?', 'What makes a good artifact?']
    },
    {
      id: 'meta-narrative',
      ...
      choices: ['That\'s fascinating!', 'So what\'s my role here?', 'How do I contribute?']
    },
    {
      id: 'your-mission',
      title: 'Your Mission',
      ...
      choices: ['That sounds amazing!', 'I\'m not sure I can do that', 'What tools do I have?']
    },
    {
      id: 'tools-and-powers',
      ...
      choices: ['Show me how to start creating', 'What powers can I unlock?', 'I want to explore first']
    },
    {
      id: 'community',
      ...
      choices: ['I\'m ready to start!', 'Tell me about collaboration', 'Show me the community features']
    },
    {
      ...
      choices: ['I accept the challenge!', 'I need a moment to think', 'Take me to the creation tools']
    }
  ];

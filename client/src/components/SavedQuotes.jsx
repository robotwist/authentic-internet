    ...
    return (
      <div className="saved-quotes-container">
        ...
        <div className="no-quotes-message">
          ...
          {onAddQuote && (
            <button className="add-quote-button" onClick={onAddQuote}>
    ...
    <div className="saved-quotes-container">
      ...
      {showShareForm && (
        <div className="share-form">
          ...
          />
          <button className="share-submit-button" onClick={handleShareQuotes}>
            Share
          </button>
        </div>
      )}
      ...
      <div className="quotes-list">
        <div className="select-all-container">
          <label>
            ...
            />
            {selectedQuotes.length > 0
              ? `Selected ${selectedQuotes.length} quotes`
              : "Select All"}
          </label>
        </div>
        ...
        {quotes.map((quote, index) => (
          <div
            key={index}
            className={`quote-item ${selectedQuotes.includes(index) ? "selected" : ""}`}
          >
            ...
            <div className="quote-content">
              ...
              <div className="quote-source">
                {quote.npcType && (
                  <span className="npc-type">{quote.npcType}: </span>
                )}
                {quote.source}
              </div>
              <div className="quote-timestamp">
                Saved on: {new Date(quote.timestamp).toLocaleDateString()}
              </div>
            </div>

...
const HamletFinale = ({ onComplete, onExit }) => {
  ...
  const getCurrentDialogue = () => {
    ...
    if (gameState === 'poison_choice') return poisonChoiceDialogue[dialogueIndex];
  ...
  return (
    <div className="hamlet-finale-container">
      ...
      {(gameState === 'intro' || gameState === 'poison_choice' || gameState === 'finale') && (
        <div className="hamlet-dialogue-box">
          ...
          >
            {gameState === 'finale' && dialogueIndex === finaleDialogue.length - 1 
              ? 'Complete Quest' 
              : 'Continue →'}
          </button>
        </div>
      ...
      {gameState === 'duel' && (
        <div className="hamlet-controls">
          <div className="status-text">
            ...
            {hasPoisonSword && <span className="poison-indicator"> [POISON BLADE] </span>}
          </div>
      ...
      {gameState === 'complete' && (
        <div className="hamlet-complete">
          ...
          <p className="reward-text">
            You have been bestowed the <span className="highlight">Wand of Prospero</span>!
          </p>

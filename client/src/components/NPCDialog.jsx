...
const NPCDialog = ({
        ...
        setResponses([
          {
            ...
            response: `I am ${npc.name}. I\'m here to help you on your journey.`,
          },
          {
            id: "default-2",
            text: "What do you know about this place?",
            response:
              "This place is full of wisdom and challenges. Explore it thoroughly.",
          },
          {
            id: "default-3",
            text: "Goodbye.",
            response: "Farewell! Come back if you need assistance.",
            isExit: true,
          },
        ]);
      } else {
  ...
  const handleResponseClick = (response) => {
    ...
    setTimeout(() => {
      ...
      if (response.grantItem && character?.id) {
        ...
        setDialogText(
          (prev) => `${prev} (Received: ${response.grantItem.name})`,
        );
      }
  ...
  return (
    <div
      className="npc-dialog-backdrop"
      onClick={() => !isLoading && onClose()}
    >
      <div
        className="npc-dialog-container"

    ...
    for (let y = 0; y < mapRows; y++) {
      for (let x = 0; x < mapCols; x++) {
        ...
        if (!isExplored && !isPlayerTile) {
          ...
          // Tile type classes
          if (tileType === 1 || tileType === 4) { // wall or dungeon
            tileClass += ' wall';
          } else if (tileType === 2) { // tree
            tileClass += ' tree';
          } else if (tileType === 3) { // sand
            tileClass += ' sand';
          } else if (tileType === 5 || tileType === 6 || tileType === 7 || tileType === 8) { // portals
            tileClass += ' portal';
          } else if (tileType === 9) { // water
            tileClass += ' water';
          } else {
            tileClass += ' walkable';
          }
  ...
  return (
    <div className="minimap-container">
      ...
      >
        ...
        {/* NPCs */}
        <div className="minimap-entities">
          {renderNPCs}
        </div>

...
const CreativeAspirations = ({ onClose, onStartCreating }) => {
  ...
  return (
    <div className="creative-aspirations-overlay" onClick={handleClose}>
      <div
        className="creative-aspirations-container"
        onClick={(e) => e.stopPropagation()}
      >
        <h2 className="creative-aspirations-title">
        ...
        <p className="creative-aspirations-description">
          The Authentic Internet is the place where you leave your creations for
          others to discover and love. Share your wisdom, inspiration, and
          creative spirit through artifacts that will touch the lives of others.
          Each creation is a reflection of you, and every interaction with your
          artifacts earns you experience and recognition.
        </p>

        <button
          className="creative-aspirations-button"

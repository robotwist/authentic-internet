...
const OnboardingFlow = ({ onComplete, onSkip }) => {
  ...
  const steps = [
    {
      ...
      description: 'Discover the creative metaverse where your imagination becomes reality',
      icon: <AutoAwesome />
    },
    {
  ...
  const artifactTypes = [
    {
      ...
      description: 'Create branching narratives, poems, or character monologues',
      icon: '📖',
      examples: ['Choose-your-own-adventure', 'Poetry collection', 'Character backstory'],
      prompts: [
  ...
  const inspirationExamples = [
    {
      ...
      examples: [
        { type: 'STORY', title: 'The Whispering Trees', description: 'A story about trees that can communicate' },
        { type: 'ART', title: 'Mountain Sunrise', description: 'A painting of dawn breaking over peaks' },
        { type: 'MUSIC', title: 'Forest Ambience', description: 'Sounds of a peaceful woodland' }
      ]
    },
    {
      id: 'adventure',
      ...
      examples: [
        { type: 'STORY', title: 'The Lost Map', description: 'A treasure hunt story with choices' },
        { type: 'PUZZLE', title: 'Ancient Riddle', description: 'Solve puzzles to unlock ancient secrets' },
        { type: 'GAME', title: 'Explorer Quest', description: 'Navigate through unknown lands' }
      ]
    },
    {
      id: 'emotions',
      ...
      examples: [
        { type: 'STORY', title: 'The Friendship Letter', description: 'A story about reconnecting with old friends' },
        { type: 'ART', title: 'Joy and Sadness', description: 'Art representing emotional contrasts' },
        { type: 'MUSIC', title: 'Heartbeat Melody', description: 'Music that captures different emotions' }
      ]
    },
    {
      id: 'technology',
      ...
      examples: [
        { type: 'STORY', title: 'The AI Companion', description: 'A story about artificial intelligence friendship' },
        { type: 'PUZZLE', title: 'Digital Codebreaker', description: 'Solve puzzles using technology' },
        { type: 'GAME', title: 'Robot Factory', description: 'Build and program robots' }
      ]
    }
  ];
  ...
  const renderTypeSelection = () => (
    <Box className="onboarding-step">
      ...
      <Typography variant="body1" className="step-description">
        What type of content would you like to create? Don't worry - you can always try different types later!
      </Typography>
  ...
  const renderInspirationStep = () => (
    <Box className="onboarding-step">
      ...
      <Typography variant="body1" className="step-description">
        Get inspired by these themes and examples. Click on any inspiration to see detailed examples!
      </Typography>
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={6}>
            <TextField
              ...
              onChange={(e) => setArtifactData(prev => ({ ...prev, name: e.target.value }))}
          ...
          <Grid item xs={12} md={6}>
            <FormControl fullWidth className="form-field">
              ...
              <Select
                ...
                onChange={(e) => setArtifactData(prev => ({ ...prev, difficulty: e.target.value }))}
              >
          ...
          <Grid item xs={12}>
            <TextField
              ...
              onChange={(e) => setArtifactData(prev => ({ ...prev, description: e.target.value }))}
          ...
          <Grid item xs={12}>
            <TextField
              ...
              onChange={(e) => setArtifactData(prev => ({ ...prev, content: e.target.value }))}
          ...
          <Grid item xs={12}>
            <TextField
              ...
              onChange={(e) => setArtifactData(prev => ({ 
                ...prev, 
  ...
  const renderDiscoveryStep = () => (
    <Box className="onboarding-step">
      ...
      <Typography variant="body1" className="step-description">
        Learn how to share your creation and discover amazing content from other creators.
      </Typography>
        ...
        <Grid item xs={12} md={4}>
          <Card className="discovery-card">
            <CardContent>
              ...
              <Typography variant="body2">
                Your artifact is now live in the world! Others can discover, play, and rate it.
              </Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} md={4}>
          <Card className="discovery-card">
            <CardContent>
              ...
              <Typography variant="body2">
                Explore artifacts by type, rating, or creator. Find inspiration for your next creation!
              </Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} md={4}>
          <Card className="discovery-card">
            <CardContent>
              ...
              <Typography variant="body2">
                Follow creators you love, join challenges, and collaborate on projects.
              </Typography>
            </CardContent>
          </Card>
        </Grid>
    ...
    <Box className="onboarding-step celebration">
      <Box className="celebration-content">
        ...
        <Typography variant="body1" className="celebration-description">
          You're now part of the Authentic Internet creative community! 
          Your artifact is live and ready to inspire others.
        </Typography>
  ...
  return (
    <Box className="onboarding-container">
      ...
      >
        ...
        <DialogActions>
          <Button onClick={() => setShowInspirationModal(false)}>
            Cancel
          </Button>
          <Button 
            variant="contained" 

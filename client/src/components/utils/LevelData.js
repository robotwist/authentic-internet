...
const LevelData = {
  ...
  levels: [
    ...
    },
    {
      ...
      bossQuote:
        "The bulls are the real heroes. No man dies as bravely as the bull.",
      victoryText:
        "You've captured the essence of Spain's tragic beauty. Africa calls with new adventures and challenges.",
    ...
    },
    {
      ...
      victoryText:
        "With Africa conquered, you've cemented your legacy as one of America's greatest writers. Your journey with Hemingway is complete.",
  ...
  getRandomHemingwayQuote(levelId) {
    const quotes =
      this.hemingwayQuotes[levelId] || this.hemingwayQuotes.generic;
  ...
  getCompletionRequirementsForLevel(levelId) {
    return (
      this.completionRequirements[levelId] || this.completionRequirements.paris
    );
  },

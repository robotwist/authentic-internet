...
export const LIBRARY_OF_ALEXANDRIA = {
  ...
  rooms: {
    ...
    entrance: {
      id: 'entrance',
      name: 'Entrance Hall',
      description: 'Ancient bookshelves line the walls. The air smells of old parchment.',
      width: 16,
      height: 11,
    ...
    central_hall: {
      id: 'central_hall',
      name: 'Central Hall',
      description: 'A grand hall with three passages. Ancient scrolls flutter in an unseen breeze.',
      width: 16,
      height: 11,
    ...
    reading_room: {
      id: 'reading_room',
      name: 'Reading Room',
      description: 'Dusty tables and chairs. Something valuable glints in the corner.',
      width: 16,
      height: 11,
    ...
    archives: {
      id: 'archives',
      name: 'Archives',
      description: 'Endless shelves of forgotten knowledge. A key rests on a pedestal.',
      width: 16,
      height: 11,
      ...
      items: [
        { type: 'small_key', position: { x: 6, y: 8 } }
      ],
    ...
    forbidden_section: {
      ...
      description: 'Books bound in chains. Dark energy emanates from the far door.',
      width: 16,
      height: 11,
    ...
    boss_room: {
      ...
      description: 'A vast chamber filled with floating books. The Librarian awaits!',
      width: 16,
      height: 11,
      isBossRoom: true,

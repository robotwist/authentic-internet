...
async function testJesusInNPCList() {
  ...
  try {
    ...
    const jesusNPC = response.data.find(
      (npc) => npc.name === "Jesus" || npc.type === "jesus",
    );
...
async function runAllTests() {
  ...
  console.log(
    "Jesus Interaction Test:",
    interactionResult.success ? "✅ PASS" : "❌ FAIL",
  );
  console.log(
    "Jesus in NPC List:",
    npcListResult.success ? "✅ PASS" : "❌ FAIL",
  );
